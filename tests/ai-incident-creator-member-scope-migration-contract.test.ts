...
const migrationPath = join(
  process.cwd(),
  'supabase/migrations/20260720014500_enforce_ai_incident_creator_member_scope.sql',
);
const migration = readFileSync(migrationPath, 'utf8');

describe('AI-incident creator member-scope migration', () => {
  it('requires a non-null creator to belong to the incident organization', () => {
