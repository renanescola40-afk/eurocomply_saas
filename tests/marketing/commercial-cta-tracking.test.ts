...
describe('commercial CTA tracking contract', () => {
  ...
  it('maps pricing and enterprise intent to stable ids', () => {
  ...
  it('rejects external destinations and private routes', () => {
  ...
  it('emits only bounded identifiers and public route context properties', () => {
    expect(buildCommercialCtaProperties('/es/pricing', 'pricing-book-demo')).toEqual({
      path: '/es/pricing', page_type: 'pricing', funnel_stage: 'commercial', cta_id: 'pricing-book-demo', source: 'public_cta',
    });
