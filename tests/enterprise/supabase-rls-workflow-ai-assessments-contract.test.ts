...
describe('Supabase post-V20 live RLS workflow contract', () => {
  ...
  it('binds the proof to exact successful V20 Production promotion evidence', () => {
    const workflow = readFileSync(workflowPath, 'utf8');
    ...
    expect(workflow).toContain('.changeSet == "2026-08-23-enterprise-data-plane-payment-first-closure-v20"');
