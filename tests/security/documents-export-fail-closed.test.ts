...
const routeSource = readFileSync(
  new URL('../../src/app/api/reports/documents.csv/route.ts', import.meta.url),
  'utf8',
);

describe('documents CSV export backend failure handling', () => {
  it('does not present an empty CSV as a successful export when the admin client is unavailable', () => {
    ...
    expect(unavailableBranch).toContain("area: 'documents_csv_export_configuration'");
