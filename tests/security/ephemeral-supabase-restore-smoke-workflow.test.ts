...
describe('ephemeral Supabase logical restore PR smoke', () => {
  ...
  it('creates an exact-SHA source, destroys it, then restores into a clean target', () => {
    const sourceStart = workflow.indexOf('manage-ephemeral-recovery-database.mjs start-project');
  ...
  it('always destroys the target and synthetic dump files even after failure', () => {
