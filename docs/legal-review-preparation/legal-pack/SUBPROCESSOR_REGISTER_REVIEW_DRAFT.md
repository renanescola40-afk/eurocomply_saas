...
|---|---|---|---|---|
| Vercel | Hosting, deployment, edge delivery and logs | traffic, deployment and diagnostic metadata | Production deployment attributable; connected team plan is Pro; contractual facts open; legal interpretation open | contracted entity/applicable agreement, processing regions where relevant, log retention, DPA and transfer terms |
