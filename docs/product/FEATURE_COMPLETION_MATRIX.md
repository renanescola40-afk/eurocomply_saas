...
| AI Inventory edit/reassessment | Complete | Detail page now has a real edit/reassessment form using `PATCH /api/ai-systems/:id`; the backend validates permission, recalculates classification, updates the record, writes history and activity metadata. | Add automated UI/API tests. |
