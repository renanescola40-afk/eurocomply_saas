...
| External security review or pentest completed | Open | `docs/security/evidence/runtime/external-security-review-or-pentest.json` must record `status: Complete` only after a real third-party report or approved external review exists; required fields include reviewer/vendor, date, scope, methodology, summary, critical/high/medium findings, resolution status, accepted risk records, retest status, and report storage location. Critical/high findings must be resolved or formally accepted, and every critical finding requires retest evidence | Security reviewer | Required before enterprise; target 2026-07-06 |
