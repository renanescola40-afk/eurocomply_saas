...
- Latest remediation commit before this register refresh: `9f75c541efef104045fde95ec3f8fcc00dc6239f`
- Vercel-success merge commit observed: `a0a4849739492133b296962d40036ba1423ab831`
- Deployment URL observed from PR #344: `https://eurocomply-saas-git-coverage1-renanescola40-afks-projects.vercel.app`
- Build log URL observed from Vercel status: `https://vercel.com/renanescola40-afks-projects/eurocomply-saas/FVPS9rK98r8ysiXPo8MR1UATF653`
...
| Production deployment / build log | Exception | Vercel status success and build log are recorded for merge commit `a0a4849739492133b296962d40036ba1423ab831`; current remediation PR branch still requires its own successful deployment and runtime smoke proof | Platform owner | Required by 2026-06-23 |
| Deployment URL functional verification | Open | Verify the recorded deployment URL and `/api/health` response from a network-capable release runner; do not mark Complete from URL presence alone | Platform owner | Required by 2026-06-23 |
