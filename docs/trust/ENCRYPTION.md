# Encryption and runtime configuration
...
Sensitive configuration is intended to be managed through deployment-provider settings and not committed to source control.
