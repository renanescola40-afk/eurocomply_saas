...
Last factual reconciliation: `2026-09-12`.
...
- a clean independent security retest/assurance state;
- VAT/tax acceptance;
...
Procurement language must therefore be: **external assessment completed; remediation/retest and terminal assurance remain open**. Do not market this as a clean pentest pass.

## Billing and fiscal truth

Fresh LIVE provider inspection observed:

- canonical active product/price configuration exists;
- the Production Stripe webhook endpoint is enabled;
- no legitimate LIVE customer, subscription or invoice was present at the audit snapshot;
- no Stripe Tax registration was present at the audit snapshot;
- active LIVE prices inspected use `tax_behavior=unspecified`.

This supports commercial-runtime preparation, but not final VAT/fiscal acceptance or a real-customer lifecycle claim.
...
External legal acceptance remains separate:
...
- `docs/enterprise/ENTERPRISE_CLOSURE_CONTROLLER_V1_2026-09-12.md`

## Current terminal blockers to disclose when material

- qualified EU AI Act/legal assurance: `0/8` accepted;
- Master Legal Opinion: open;
- Portuguese VAT/tax acceptance: open;
- external security remediation and retest: open;
- any buyer-required additional manual/qualified pentest scope: open if required by the buyer standard;
- legitimate LIVE paid-customer authority: external-customer dependent and not yet evidenced;
