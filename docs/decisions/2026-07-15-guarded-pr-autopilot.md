...
- source-contract tests for trusted policy loading, no checkout in the privileged controller, exact-head merge, review/check/thread requirements, Codex permission profile, bounded attempts, blocked paths, and Vercel quota PR-delivery behavior;
