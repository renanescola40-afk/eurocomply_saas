      ...
      <div className="grid md:grid-cols-[minmax(0,1fr)_220px]">
        <div className="px-5 py-5 md:px-6">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-emerald-100/55">Follow-up planning</p>
        ...
        <div className="flex items-center border-t border-white/[0.055] px-5 py-5 md:border-l md:border-t-0">
          <Link href={plan.href} className="inline-flex h-10 w-full items-center justify-center rounded-lg bg-emerald-300 px-4 text-sm font-semibold text-[#07110d] transition hover:bg-emerald-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-200/60">Open follow-up area</Link>
        </div>
      </div>
    </section>
  );
