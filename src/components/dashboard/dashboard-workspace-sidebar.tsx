  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Regulatory Control Tower', description: 'Cross-workstream evidence readiness', href: `${basePath}/regulatory-control-tower`, icon: '◉', signal: 'EU AI', accent: 'emerald' },
