    ...
    <section className="overflow-hidden rounded-xl border border-white/[0.075] bg-[#0d1522] text-white">
      <div className="grid xl:grid-cols-[300px_minmax(0,1fr)]">
        <div className="border-b border-white/[0.055] px-5 py-5 xl:border-b-0 xl:border-r">
          <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-violet-200/65">Leadership notes</p>
        ...
        <div className="divide-y divide-white/[0.055]">
          {notes.map((note) => (
            <Link key={note.question} href={note.href} className="group block px-5 py-4 transition hover:bg-violet-300/[0.025] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-violet-400/40 md:px-6">
              <div className="grid gap-3 md:grid-cols-[240px_minmax(0,1fr)_auto] md:items-start">
                ...
                <span className="text-xs font-semibold text-violet-200/60 transition group-hover:text-violet-100">Open →</span>
              </div>
            </Link>
          ))}
        </div>
