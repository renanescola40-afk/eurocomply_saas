...
const pageContent = {
  ...
  security: {
    ...
    sections: [
      ...
      { title: 'Route health', body: 'Public and private surfaces are covered by Playwright route checks for unexpected 404, 500 and invalid locale links.' },
    ],
  },
  compliance: {
    eyebrow: 'Compliance',
  ...
  faq: {
    ...
    sections: [
      ...
      { title: 'How is broken navigation prevented?', body: 'Critical public links, private redirects, invalid-locale patterns and stack traces are checked by CI.' },
    ],
  },
  about: {
