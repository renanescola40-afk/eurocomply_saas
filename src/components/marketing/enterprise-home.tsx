...
const portugueseCopy: LandingCopy = {
  ...
  heroSubtitle: 'O EuroComply ajuda equipas europeias a centralizar evidências, riscos, fornecedores, roles e trilhas de auditoria mantendo claims de segurança ligados à implementação documentada.',
  cta: { start: 'Assinar agora', demo: 'Ver demonstração', trust: 'Ver Trust Center', learnMore: 'Saiba mais' },
  cockpit: { ...englishCopy.cockpit, title: 'Workspace de compliance', live: 'Vista do workspace' },
  ...
  features: { ...englishCopy.features, eyebrow: 'Funcionalidades', title: 'O que as equipas operam no EuroComply' },
