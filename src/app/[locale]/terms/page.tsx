    ...
    <main className="min-h-screen bg-[#0A0A0F] px-6 py-24 text-[#E0E0E0]">
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <header className="space-y-4">
          ...
          <p className="max-w-2xl text-lg leading-8 text-white/65">These production draft terms define acceptable use, subscriptions and service responsibilities for Risck comply business customers.</p>
        </header>
        <section className="space-y-5 rounded-3xl border border-white/10 bg-white/[0.03] p-8 leading-7 text-white/70">
          ...
          <p>Risck comply provides compliance operations software for European businesses, including calendars, documents, risk workflows, audit logs, notifications, vendor records and subscription-based access controls.</p>
          ...
          <p>Risck comply supports compliance operations but does not replace qualified legal, tax or regulatory advice.</p>
        </section>
      </div>
    </main>
  );
