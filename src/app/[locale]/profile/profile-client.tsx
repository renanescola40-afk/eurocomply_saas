      ...
      <div className="mx-auto max-w-7xl space-y-8 px-4 py-8 md:px-8 md:py-12">
        ...
        <form id="company-data" onSubmit={saveProfile} className="grid gap-6 lg:grid-cols-[1.12fr_0.88fr]">
          <section className="rounded-[2rem] border bg-background/88 p-6 shadow-sm backdrop-blur">
            <div className="flex items-center gap-3"><div className="rounded-2xl bg-primary/10 p-3 text-primary"><Building2 className="h-5 w-5" /></div><div><h2 className="text-2xl font-semibold tracking-tight">Dados da empresa</h2><p className="text-sm text-muted-foreground">Campos editáveis. O logo usa upload simulado ou URL.</p></div></div>
