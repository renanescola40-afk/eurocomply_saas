        ...
        <div className="grid gap-6 lg:grid-cols-[1.12fr_0.88fr]">
          <section className="rounded-[2rem] border bg-background/88 p-6 shadow-sm backdrop-blur">
            <div className="flex items-center gap-3">
              ...
              <div><h2 className="text-2xl font-semibold tracking-tight">Dados da empresa</h2><p className="text-sm text-muted-foreground">Campos editáveis. O logo usa upload simulado ou URL.</p></div>
            </div>
