...
const COPY: Record<SupportedLocale, {
  ...
  en: {
    ...
    sections: [
      ...
      { title: 'Document storage', description: 'Controlled documents are stored in a private Supabase Storage bucket with metadata, checksum and organization scoping.', icon: 'file' },
      ...
      { title: 'Minimisation', description: 'EuroComply aims to collect only the information needed to run compliance workflows and customer operations.', icon: 'lock' },
    ],
  },
  pt: {
    eyebrow: 'Tratamento de Dados',
    title: 'Como o EuroComply trata e protege dados de clientes.',
    description: 'Uma visão prática para equipas de procurement, privacidade e segurança que avaliam o EuroComply como plataforma europeia de compliance.',
    ...
    sections: [
      ...
      { title: 'Armazenamento documental', description: 'Documentos controlados são armazenados num bucket privado do Supabase Storage com metadata, checksum e escopo por organização.', icon: 'file' },
      ...
      { title: 'Minimização', description: 'O EuroComply procura recolher apenas a informação necessária para executar workflows de compliance e operação do cliente.', icon: 'lock' },
    ],
  },
  es: {
    eyebrow: 'Tratamiento de Datos',
    title: 'Cómo EuroComply trata y protege los datos de clientes.',
    description: 'Una visión práctica para equipos de compras, privacidad y seguridad que evalúan EuroComply como plataforma europea de compliance.',
    ...
    sections: [
      ...
      { title: 'Almacenamiento documental', description: 'Los documentos controlados se almacenan en un bucket privado de Supabase Storage con metadata, checksum y alcance por organización.', icon: 'file' },
      ...
      { title: 'Minimización', description: 'EuroComply busca recoger solo la información necesaria para ejecutar workflows de compliance y operación del cliente.', icon: 'lock' },
    ],
  },
  fr: {
    eyebrow: 'Traitement des Données',
    title: 'Comment EuroComply traite et protège les données clients.',
    description: 'Une vue pratique pour les équipes achats, confidentialité et sécurité évaluant EuroComply comme plateforme européenne de conformité.',
    ...
    sections: [
      ...
      { title: 'Stockage documentaire', description: 'Les documents contrôlés sont stockés dans un bucket privé Supabase Storage avec métadonnées, checksum et périmètre organisationnel.', icon: 'file' },
      ...
      { title: 'Minimisation', description: 'EuroComply vise à collecter uniquement les informations nécessaires aux workflows de conformité et opérations client.', icon: 'lock' },
    ],
  },
  it: {
    eyebrow: 'Trattamento Dati',
    title: 'Come EuroComply tratta e protegge i dati dei clienti.',
    description: 'Una panoramica pratica per procurement, privacy e security team che valutano EuroComply come piattaforma europea di compliance.',
    ...
    sections: [
      ...
      { title: 'Storage documentale', description: 'I documenti controllati sono archiviati in un bucket privato Supabase Storage con metadata, checksum e scope organizzativo.', icon: 'file' },
      ...
      { title: 'Minimizzazione', description: 'EuroComply mira a raccogliere solo le informazioni necessarie per workflow compliance e operazioni cliente.', icon: 'lock' },
    ],
  },
  de: {
    eyebrow: 'Datenverarbeitung',
    title: 'Wie EuroComply Kundendaten verarbeitet und schützt.',
    description: 'Eine praktische Übersicht für Einkauf, Datenschutz und Security Teams, die EuroComply als europäische Compliance-Plattform bewerten.',
    ...
    sections: [
      ...
      { title: 'Dokumentenspeicherung', description: 'Kontrollierte Dokumente werden in einem privaten Supabase Storage Bucket mit Metadaten, Prüfsumme und Organisationsumfang gespeichert.', icon: 'file' },
      ...
      { title: 'Minimierung', description: 'EuroComply zielt darauf ab, nur Informationen zu erheben, die für Compliance-Workflows und Kundenbetrieb notwendig sind.', icon: 'lock' },
    ],
  },
};
