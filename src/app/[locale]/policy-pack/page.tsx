...
const copy = {
  en: { badge: 'Policy pack generator', title: 'AI governance policy pack', subtitle: 'Generate board-ready AI usage, employee guidance and evidence policy sections from live inventory data.', empty: 'Policy pack generation needs at least one AI system in the inventory.', inventory: 'Open inventory', print: 'Review print-ready pack', employee: 'Employee AI usage policy' },
