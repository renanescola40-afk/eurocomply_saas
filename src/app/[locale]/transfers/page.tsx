  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'This page remains REVIEW_DRAFT · HUMAN_REVIEW_REQUIRED. International transfer closure requires account-specific provider/contract evidence and a documented legal basis where a specific issue cannot be closed from applicable law and attributable facts alone.',
      ],
    },
  ],
};
