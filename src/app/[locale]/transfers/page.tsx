  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'Runtime presence, source configuration, plan level, billing entity and historical release evidence are useful factual signals but are not substitutes for an account-applicable transfer mechanism or documented legal determination.',
      ],
    },
    {
      title: 'Supabase',
    ...
    },
    {
      title: 'Vercel',
      paragraphs: [
        'The connected Vercel team is currently Pro. The RISCK COMPLY Vercel project is linked to the correct GitHub repository and configured domains include www.risckcomply.com and risckcomply.com. These account/project/domain facts were revalidated on 10 September 2026.',
    ...
    },
    {
      ...
      items: [
        ...
        'PostHog: connected access was revalidated on 10 September 2026 and returned one accessible Default project with no ingested event and no configured application URLs. That connected project is not promoted as RISCK COMPLY Production. The actual Production analytics project/account, retention and account-linked DPA/transfer facts remain unverified; repository EU endpoint configuration proves implementation only.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'This page remains REVIEW_DRAFT · FACTUAL_CLOSURE_REQUIRED. International transfer closure requires account-specific provider/contract evidence and a documented legal basis where a specific issue cannot be closed from applicable law and attributable facts alone.',
      ],
    },
  ],
};
...
const pt: TransferCopy = {
  ...
  sections: [
    ...
    { title: 'Outros fornecedores operacionais', items: ['Google OAuth / Google Identity: integração de autenticação existe através do Supabase Auth; termos aplicáveis, função jurídica, localizações completas, retenção e transferências continuam em revisão.', 'Google Workspace: o correio corporativo está operacional. Evidência anterior de plano/entidade EMEA não é tratada como conclusão de região de armazenamento/tratamento; acordo/CDPA e transferências ulteriores atuais ainda exigem evidência.', 'GitHub / GitHub Actions: repositório e workflows protegidos de CI/recovery estão ativos, e workflows autorizados podem tratar transitoriamente dados da base Production em GitHub-hosted runners. DPA da conta, tratamento/transferências nos runners e função jurídica final continuam abertos.', 'Sentry: a integração permanece presente; evidência exact-release anterior é histórica até nova aceitação protegida atual. Região, retenção, DPA e transferências da conta permanecem abertos.', 'PostHog: o acesso conectado foi revalidado em 10 de setembro de 2026 e devolveu um único Default project sem eventos ingeridos e sem application URLs configurados. Esse projeto não é promovido como Production da RISCK COMPLY. A conta/projeto Production real, retenção e factos de DPA/transferências da conta continuam não verificados; configuração de endpoints UE no repositório prova apenas implementação.', 'Upstash: a integração Redis de rate-limit/segurança permanece implementada. Prova direta anterior é histórica; aceitação protegida atual e plano/owner, região, retenção, DPA e transferências continuam abertos.', 'Resend / email transacional: existe evidência histórica de entrega, mas binding atual exact-release e factos de conta/região/retenção/DPA/transferências continuam abertos.', 'Malware/content scanner: fornecedor externo permanece condicional até existir atribuição de provider/conta; não é feita conclusão de transferência para fornecedor não verificado.'] },
    ...
    { title: 'Contratação com clientes e aceitação final', paragraphs: ['O DPA final, registo de subprocessadores e anexo de transferências devem refletir os fornecedores realmente utilizados para dados pessoais de clientes, localizações/papéis aplicáveis e o mecanismo de cada fluxo relevante. Alterações materiais devem seguir o mecanismo final de aviso/autorização quando exigido.', 'Esta página permanece REVIEW_DRAFT · FACTUAL_CLOSURE_REQUIRED. O fecho de transferências exige evidência específica de provider/conta/contrato e uma base jurídica documentada quando uma questão concreta não possa ser fechada apenas pela lei aplicável e por factos atribuíveis.'] },
  ],
};
