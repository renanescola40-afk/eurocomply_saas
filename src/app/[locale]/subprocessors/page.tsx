...
const subprocessors = [
  { name: 'Vercel', purpose: 'Application hosting and edge delivery', location: 'Global infrastructure' },
  { name: 'Supabase', purpose: 'Database and authentication services', location: 'Configured project region' },
  { name: 'Stripe', purpose: 'Subscription billing and customer portal', location: 'Global payments infrastructure' },
  { name: 'Sentry', purpose: 'Application monitoring and diagnostics', location: 'Configured account region' },
];
    ...
    <main className="min-h-screen bg-[#0A0A0F] px-6 py-24 text-[#E0E0E0]">
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <header className="space-y-4">
          ...
          <p className="max-w-2xl text-lg leading-8 text-white/65">RISCK COMPLY may use the following subprocessors to operate hosting, authentication, billing and monitoring for customers.</p>
        </header>
