    ...
    <main className="min-h-screen bg-[#0A0A0F] px-6 py-24 text-[#E0E0E0]">
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <header className="space-y-4">
          ...
          <p className="max-w-2xl text-lg leading-8 text-white/65">This production draft describes processor obligations for customer-controlled personal data processed inside RISCK COMPLY.</p>
        </header>
        <section className="space-y-5 rounded-3xl border border-white/10 bg-white/[0.03] p-8 leading-7 text-white/70">
          ...
          <p>The customer acts as controller for personal data uploaded to the platform. RISCK COMPLY acts as processor when operating the service on behalf of the customer.</p>
          <h2 className="text-2xl font-semibold text-white">Processing instructions</h2>
          <p>RISCK COMPLY processes customer data only to provide the contracted service, maintain security, support billing, deliver notifications and comply with lawful obligations.</p>
