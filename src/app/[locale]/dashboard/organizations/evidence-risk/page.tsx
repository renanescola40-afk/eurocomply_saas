...
import { EvidenceRiskPage } from '@/components/dashboard/dashboard-overview';
import { getCurrentUser } from '@/server/queries/auth';
import { getOrganizationDashboardData } from '@/server/queries/organization-dashboard';

export default async function OrganizationEvidenceRiskPage({ params }: { params: { locale: string } }) {
