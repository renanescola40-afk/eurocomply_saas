...
const copy: Record<Locale, DashboardCopy> = {
  pt: {
    ...
    noPlaceholders: 'Sem CTAs mortos, texto provisório ou dados inventados.',
  ...
  en: {
    ...
    noPlaceholders: 'No dead CTAs, temporary copy or invented data.',
  ...
  es: {
    ...
    noPlaceholders: 'Sin CTAs muertos, texto temporal ni datos inventados.',
  ...
  fr: {
    ...
    noPlaceholders: 'Aucun CTA mort, texte provisoire ou donnée inventée.',
  ...
  it: {
    ...
    noPlaceholders: 'Nessun CTA morto, testo provvisorio o dato inventato.',
  ...
  de: {
    ...
    noPlaceholders: 'Keine toten CTAs, temporären Texte oder erfundenen Daten.',
