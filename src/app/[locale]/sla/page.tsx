...
const content: Record<SupportedLocale, { title: string; subtitle: string; back: string; sections: { title: string; body: string; icon: 'clock' | 'server' | 'shield' | 'support' | 'activity' }[]; note: string }> = {
  en: {
    ...
    subtitle: 'Operational expectations for RISCK COMPLY customers evaluating availability, support and incident handling.',
    back: 'Back to Trust Center',
    sections: [
      { title: 'Availability target', body: 'RISCK COMPLY is designed for high availability on managed cloud infrastructure. Public status and operational checks support customer monitoring.', icon: 'activity' },
    ...
    note: 'This page describes the operational posture of RISCK COMPLY. Contractual commitments are governed by the executed agreement with each customer.',
  },
  pt: {
    title: 'Compromissos de Serviço',
    subtitle: 'Expectativas operacionais para clientes RISCK COMPLY que avaliam disponibilidade, suporte e resposta a incidentes.',
    back: 'Voltar ao Trust Center',
    sections: [
      { title: 'Objetivo de disponibilidade', body: 'O RISCK COMPLY é desenhado para elevada disponibilidade em infraestrutura cloud gerida. A página de estado e os checks operacionais apoiam a monitorização.', icon: 'activity' },
    ...
    note: 'Esta página descreve a postura operacional do RISCK COMPLY. Compromissos contratuais são regidos pelo acordo assinado com cada cliente.',
  },
  es: {
    title: 'Compromisos de Servicio',
    subtitle: 'Expectativas operativas para clientes RISCK COMPLY que evalúan disponibilidad, soporte y gestión de incidentes.',
    back: 'Volver al Trust Center',
    sections: [
      { title: 'Objetivo de disponibilidad', body: 'RISCK COMPLY está diseñado para alta disponibilidad sobre infraestructura cloud gestionada. El estado público y los checks operativos ayudan a la monitorización.', icon: 'activity' },
    ...
    note: 'Esta página describe la postura operativa de RISCK COMPLY. Los compromisos contractuales se rigen por el acuerdo firmado con cada cliente.',
  },
  fr: {
    title: 'Engagements de Service',
    subtitle: 'Attentes opérationnelles pour les clients RISCK COMPLY évaluant disponibilité, support et réponse aux incidents.',
    back: 'Retour au Trust Center',
    sections: [
      { title: 'Objectif de disponibilité', body: 'RISCK COMPLY est conçu pour une haute disponibilité sur une infrastructure cloud managée. Le statut public et les contrôles opérationnels facilitent le suivi.', icon: 'activity' },
    ...
    note: 'Cette page décrit la posture opérationnelle de RISCK COMPLY. Les engagements contractuels sont régis par l’accord signé avec chaque client.',
  },
  it: {
    title: 'Impegni di Servizio',
    subtitle: 'Aspettative operative per clienti RISCK COMPLY che valutano disponibilità, supporto e gestione degli incidenti.',
    back: 'Torna al Trust Center',
    sections: [
      { title: 'Obiettivo di disponibilità', body: 'RISCK COMPLY è progettato per alta disponibilità su infrastruttura cloud gestita. Stato pubblico e controlli operativi supportano il monitoraggio.', icon: 'activity' },
    ...
    note: 'Questa pagina descrive la postura operativa di RISCK COMPLY. Gli impegni contrattuali sono regolati dall’accordo firmato con ciascun cliente.',
  },
  de: {
    title: 'Service Commitments',
    subtitle: 'Operative Erwartungen für RISCK COMPLY-Kunden zu Verfügbarkeit, Support und Incident Handling.',
    back: 'Zurück zum Trust Center',
    sections: [
      { title: 'Verfügbarkeitsziel', body: 'RISCK COMPLY ist für hohe Verfügbarkeit auf verwalteter Cloud-Infrastruktur ausgelegt. Öffentlicher Status und operative Checks unterstützen Monitoring.', icon: 'activity' },
    ...
    note: 'Diese Seite beschreibt die operative Haltung von RISCK COMPLY. Vertragliche Zusagen richten sich nach der jeweiligen Kundenvereinbarung.',
  },
};
    ...
    <main className="min-h-screen bg-[#0A0A0F] px-6 py-24 text-[#E0E0E0]">
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-10 rounded-[2rem] border border-white/10 bg-white/[0.03] p-8 shadow-2xl shadow-black/30 md:p-12">
          <p className="text-sm uppercase tracking-[0.35em] text-white/45">RISCK COMPLY Trust</p>
