    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button size="sm" onClick={() => router.push('/dashboard/inventario/novo')} className="bg-white text-black hover:bg-white/90">
        ...
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              {!hasFilters && (
                <Button variant="outline" onClick={() => router.push('/dashboard/inventario/novo')} className="border-white/10 text-white/60 hover:text-white">
                ...
                <tbody>
                  {filtered.map(tool => (
                    <tr key={tool.id} className="border-b border-white/5 hover:bg-white/[0.02] transition cursor-pointer"
                      onClick={() => router.push(`/dashboard/inventario/${tool.id}`)}>
