            ...
            <CardContent className="space-y-4">
              {selectedTool ? (
                ...
                <div className="space-y-3">
                  ...
                  {tools.length === 0 ? (
                    <p className="text-sm text-white/40">Nenhum sistema no inventário. <button className="text-[#2563EB] underline" onClick={() => router.push('/dashboard/inventario/novo')}>Criar primeiro caso.</button></p>
                  ) : (
