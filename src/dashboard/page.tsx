            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    size="sm"
                    onClick={() => router.push('/dashboard/inventario/novo')}
                  ...
                  <div className="divide-y divide-white/10">
                    ...
                    {aiTools.length === 0 && (
                      <div className="p-8 text-center">
                        ...
                        <Button variant="outline" onClick={() => router.push('/dashboard/inventario/novo')}
          ...
          {activeTab === 'transparency' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <Button onClick={() => router.push('/dashboard/transparencia')} className="bg-white text-black hover:bg-white/90">
