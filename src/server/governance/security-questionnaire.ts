...
export const SECURITY_QUESTIONNAIRE_ITEMS: SecurityQuestionnaireItem[] = [
  {
    id: 'company-overview',
    category: 'company',
    question: 'What does RISCK COMPLY do?',
    answer: 'RISCK COMPLY is a European B2B compliance platform for evidence management, risk, vendors, audit readiness and AI governance workflows.',
  ...
  },
  {
    ...
    answer: 'RISCK COMPLY uses organization-scoped access patterns and Supabase row-level security policies for application data isolation.',
  ...
  },
  {
    ...
    answer: 'RISCK COMPLY includes centralized RBAC for organization roles such as owner, admin, editor, member and viewer, with feature-level permissions for sensitive operations.',
  ...
  },
  {
    ...
    answer: 'RISCK COMPLY records audit events for key operations including billing sync, AI governance actions, evidence exports and operational changes where implemented.',
  ...
  },
  {
    ...
    answer: 'RISCK COMPLY maintains incident response documentation and includes an internal AI Incident Register for governance workflows.',
  ...
  },
  {
    ...
    answer: 'RISCK COMPLY maintains a public subprocessors page and an internal Vendor Assurance Center for operational review of key providers.',
  ...
  },
  {
    ...
    answer: 'RISCK COMPLY provides public Privacy, DPA, Subprocessors and Data Processing pages, and supports GDPR export/delete request workflows inside the product.',
  ...
  },
  {
    ...
    answer: 'RISCK COMPLY includes AI Systems Inventory, AI Act classification, Provider vs Deployer guidance, AI Incident Register and AI Governance readiness scoring.',
  ...
  },
  {
    id: 'sso-mfa',
    category: 'access_control',
    question: 'Does RISCK COMPLY support SSO and enforced MFA?',
  ...
  },
  {
    id: 'certifications',
    category: 'compliance',
    question: 'Does RISCK COMPLY hold SOC 2 or ISO 27001 certification?',
