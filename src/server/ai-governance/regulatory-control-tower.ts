export const REGULATORY_CONTROL_TOWER_WORKSTREAMS = ['ai_literacy','fria','prohibited_practices','high_risk_provider_data','annex_iv','qms','conformity'] as const;
...
const DEFINITIONS:Record<RegulatoryControlTowerWorkstreamId,{label:string;articleReference:string;weight:number;route:string|null}>={
 ...
 annex_iv:{label:'Annex IV Technical Documentation',articleReference:'Article 11 and Annex IV',weight:6,route:'/dashboard/annex-iv'},
 qms:{label:'Quality Management System',articleReference:'Article 17',weight:5,route:'/dashboard/qms'},
