-- Prevent enterprise governance records from referencing AI systems owned by another tenant.
-- Prospective enforcement: existing rows are not rewritten or represented as validated evidence.
