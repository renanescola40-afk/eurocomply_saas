...
create table if not exists public.qualified_review_assignments (
  ...
  foreign key (campaign_id, organization_id)
    references public.qualified_review_campaigns(id, organization_id) on delete cascade,
  foreign key (reviewer_id, organization_id)
    references public.qualified_reviewers(id, organization_id) on delete restrict
);
...
create table if not exists public.qualified_review_submissions (
  ...
  foreign key (assignment_id, organization_id)
    references public.qualified_review_assignments(id, organization_id) on delete cascade
);
...
create table if not exists public.qualified_review_decisions (
  ...
  foreign key (submission_id, organization_id)
    references public.qualified_review_submissions(id, organization_id) on delete restrict
);
