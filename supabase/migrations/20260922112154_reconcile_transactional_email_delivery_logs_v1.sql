...
create policy "email delivery logs service role select"
  on public.email_delivery_logs for select to service_role using (true);

create policy "email delivery logs service role insert"
  on public.email_delivery_logs for insert to service_role with check (true);

create policy "email delivery logs service role update"
  on public.email_delivery_logs for update to service_role using (true) with check (true);
