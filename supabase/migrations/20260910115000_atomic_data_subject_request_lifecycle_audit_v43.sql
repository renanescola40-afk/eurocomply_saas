...
-- Re-forward the reviewed atomic GDPR lifecycle contract above the current
-- Production migration head. The historical 20260909223000 source migration is
-- below the remote head and therefore cannot enter the bounded forward lane.
-- Keep the exact transaction semantics while assigning a fresh forward identity.
