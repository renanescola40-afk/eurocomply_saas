-- Restore Sales Console actor attribution integrity after Production runtime reconciliation.
-- The reconciled tables are backend/service-role only, but actor/owner references must
-- still be restricted to enabled platform administrators at the database boundary.
