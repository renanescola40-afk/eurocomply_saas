...
const REQUIRED_DISCLAIMERS = new Map([
  ...
  ['docs/trust/DATA_PROTECTION.md', ['Customer data', 'retention', 'approved evidence']],
  ['docs/trust/ACCESS_CONTROL.md', ['RBAC', 'RLS', 'owner']],
  ['docs/trust/ENCRYPTION.md', ['managed providers', 'does not claim']],
  ['docs/trust/INCIDENT_RESPONSE.md', ['incident', 'does not claim']],
  ['docs/trust/BACKUP_AND_RECOVERY.md', ['backup', 'does not claim']],
  ['docs/trust/SUBPROCESSORS.md', ['Vercel', 'Supabase', 'Stripe']],
  ['docs/trust/SECURITY_FAQ.md', ['SOC 2', 'ISO 27001', 'renansilva2002@gmail.com']],
  ['docs/trust/ENTERPRISE_PROCUREMENT_PACKET.md', ['procurement', 'Do not answer yes']],
