...
export function validateSupabaseLiveReattestationSource(evidence, { expectedSha, expectedRunId }) {
...
async function main(argv) {
  ...
  process.stdout.write(`${JSON.stringify(validateSupabaseLiveReattestationSource(evidence, { expectedSha, expectedRunId }))}\n`);
}
