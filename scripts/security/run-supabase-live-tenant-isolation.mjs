...
documents: { seed: { organization_id: orgB.id, name: `tenant-b-doc-${suffix}`, category: 'general' }, insert: { organization_id: orgB.id, name: `cross-doc-${suffix}`, category: 'general' }, update: { name: `mutated-doc-${suffix}` } },    audit_events: { seed: { organization_id: orgB.id, actor_id: userB.id, actor_user_id: userB.id, action: 'seeded_event', entity_type: 'rls_validation', entity_id: suffix }, insert: { organization_id: orgB.id, actor_id: userA.id, actor_user_id: userA.id, action: 'cross_tenant_attempt', entity_type: 'rls_validation', entity_id: suffix }, update: { action: 'mutated_event' } },
