...
const requiredTokens = {
  ...
  liveValidation: ['run-audit-chain-live-validation', 'append_audit_event_chained', 'AUDIT_CHAIN_LIVE_ORGANIZATION_ID', 'AUDIT_CHAIN_LIVE_PROOF', 'appendConcurrent', 'tamperDetection', 'missingPreviousHash', 'criticalEventCoverage', 'enterpriseRelease', 'audit_chain_target_live_validation_incomplete'],
