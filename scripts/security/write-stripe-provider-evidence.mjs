...
if (portalContract?.schema !== 'risck-comply.stripe-billing-portal-contract.v1') {
  throw new Error('Invalid Stripe Billing Portal contract schema');
}
if (
  portalContract.configurationId !== null
  && (
    typeof portalContract.configurationId !== 'string'
...
const portalConfigurationBindingMode = portalContract.configurationId ? 'explicit' : 'default';
