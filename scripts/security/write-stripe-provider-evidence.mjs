...
const evidence = {
  ...
  summary: 'Protected Stripe API validation confirmed test-mode account access, active recurring Starter, Growth and Enterprise catalog prices and an enabled HTTPS webhook endpoint with the required billing events for the exact release SHA.',
  controlsVerified: [
    'Stripe proof uses test mode only',
    'Starter, Growth and Enterprise catalog prices exist and are active recurring prices',
