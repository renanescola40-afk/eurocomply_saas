...
const requiredFiles = [
  ...
  'docs/PHASE2_DAY3_CLOSEOUT.md',
  'docs/PHASE2_DAY4_CLOSEOUT.md',
  ...
  'scripts/dev/capture-phase2-day3-smoke.mjs',
  'scripts/dev/check-phase2-day3-evidence.mjs',
  'scripts/dev/check-phase2-day4-evidence.mjs',
...
for (const script of [
  ...
  'phase2:day3:smoke',
  'phase2:day3:evidence',
  'phase2:day3:closeout',
  'phase2:day4:evidence',
  'phase2:day4:closeout',
  'phase2:ci',
  'phase2:evidence',
  'security:ci',
]) {
