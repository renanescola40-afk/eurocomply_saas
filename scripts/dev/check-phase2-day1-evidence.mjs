...
console.log('Phase 2 Day 1 evidence status');
console.log('-----------------------------');
...
if (failures.length > 0) {
  console.error('Phase 2 Day 1 evidence incomplete: ' + failures.length + ' item(s) missing or failing.');
  process.exit(1);
}

console.log('Phase 2 Day 1 evidence complete.');
